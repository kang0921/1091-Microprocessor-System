...
int main()
{
	...
	int switchIn = (GPIO_PTC_PADIN >> 2) & 0x0000000F; // 讀取SW的輸入

	while(1){ //讓它一直維持讀取SW的輸入
		switchIn = (GPIO_PTC_PADIN >> 2) & 0x0000000F;
		//A();
		if( switchIn == 1 ){
